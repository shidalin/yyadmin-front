...
<div>
    ...
    <!--数据表格  -->
    <Table :data="documents" :columns="documentTableColumns" height="500" stripe></Table>
    <!--分页  -->
    ...
    <!--明细信息  -->
    <div>
        <Modal :mask-closable="false" :closable="false" v-model="modalShow" width="800" title="文档信息" ok-text="保存" @on-cancel="modalClosedEvent" @on-ok="modalConfirmEvent">
            <Form label-position="left" :label-width="80" ref="modalForm" :model="modalForm" :rules="modalRule">
                <Row>
                    <Col span="11">
                    <Form-item label="文档主键" prop="id">
                        <Input v-model="modalForm.id" type="text" placeholder="请输入文档主键"></Input>
                    </Form-item>
                    </Col>
                ...
                <Row>
                    ...
                    <Col span="11" offset="2">
                    <Form-item label="文档名称" prop="documentName">
                        <Input v-model="modalForm.documentName" type="text" placeholder="请输入文档名称"></Input>
                    </Form-item>
                    </Col>
                </Row>
                <Row>
                    <Col span="11">
                    <Form-item label="文档编码" prop="documentCode">
                        <Input v-model="modalForm.documentCode" type="text" placeholder="请输入文档编码"></Input>
                    </Form-item>
                    </Col>
                    <Col span="11" offset="2">
                    <Form-item label="文档内容" prop="documentContent">
                        <Input v-model="modalForm.documentContent" type="text" placeholder="请输入文档内容"></Input>
                    </Form-item>
                    </Col>
                </Row>
                <Row>
                    <Col span="11">
                    <Form-item label="人员主键" prop="pkUser">
                        <Input v-model="modalForm.pkUser" type="text" placeholder="请输入人员主键"></Input>
                    </Form-item>
                    </Col>
                    <Col span="11" offset="2">
                    <Form-item label="人员名称" prop="userName">
                        <Input v-model="modalForm.userName" type="text" placeholder="请输入人员名称"></Input>
                    </Form-item>
                    </Col>
                </Row>
                <Row>
                    <Col span="11">
                    <Form-item label="项目主键" prop="pkProject">
                        <Input v-model="modalForm.pkProject" type="text" placeholder="请输入项目主键"></Input>
                    </Form-item>
                    </Col>
                    <Col span="11" offset="2">
                    <Form-item label="需求主键" prop="pkRequirement">
                        <Input v-model="modalForm.pkRequirement" type="text" placeholder="请输入需求主键"></Input>
                    </Form-item>
                    </Col>
                </Row>
            </Form>
...
export default {
    ...
    //钩子方法，页面渲染结束后加载
    created() {
        this.list_document(this.current, this.pageSize);
    },
    methods: {
        //远程请求数据
        list_document(current, pageSize) {
            //参数
            let params = {
                'page': current,
                'size': pageSize
            ...
            promise.then((result) => {
                this.documents = result.data.list;
        ...
        modalConfirmEvent() {
            ...
            if (self.modalForm.id == undefined || self.modalForm.id == null || self.modalForm.id == "") {
                ...
                promise.then((result) => {
                    //局部更新数据
                    Vue.set(self.documents, self.modalIndex, result.data.data);
                    self.$Message.success("保存成功");
                })
            }
        },
        pageRefreshEvent(current, pageSize) {
            this.list_document(current, pageSize);
        }
    }
}
</script>
