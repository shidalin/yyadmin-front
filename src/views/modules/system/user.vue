...
<div>
    ...
    <!--明细信息  -->
    <div>
        <Modal :mask-closable="false" :closable="false" v-model="modalShow" width="1200" title="用户信息" ok-text="保存" @on-cancel="modalClosedEvent" @on-ok="modalConfirmEvent">
            <Form label-position="left" :label-width="100" ref="modalForm" :model="modalForm" :rules="modalRule">
                <Row>
                    <Col span="11">
                    <Form-item label="用户名称" prop="userName">
                        <Input v-model="modalForm.userName" type="text" placeholder="请输入用户名称"></Input>
                    </Form-item>
                    </Col>
                    <Col span="1"> &nbsp;
                    </Col>
                ...
                <Row>
                    <Col span="11">
                    <Form-item label="用户密码" prop="userPswd">
                        <Input v-model="modalForm.userPswd" type="text" placeholder="请输入用户密码"></Input>
                    </Form-item>
                    </Col>
                    <Col span="1"> &nbsp;
                    </Col>
                ...
                <Row>
                    <Col span="11">
                    <Form-item label="用户手机" prop="userPhone">
                        <Input v-model="modalForm.userPhone" type="text" placeholder="请输入用户手机"></Input>
                    </Form-item>
                    </Col>
                    <Col span="1"> &nbsp;
                    </Col>
                    ...
                    <Form-item label="用户类型" prop="userType">
                        <Input v-model="modalForm.userType" type="text" placeholder="请输入用户类型"></Input>
                    </Form-item>
                    </Col>
                    <Col span="1"> &nbsp;
                    </Col>
                ...
                <Row>
                    <Col span="11">
                    <Form-item label="盐" prop="salt">
                        <Input v-model="modalForm.salt" type="text" placeholder="请输入盐"></Input>
                    </Form-item>
                    </Col>
                    <Col span="1"> &nbsp;
                    </Col>
