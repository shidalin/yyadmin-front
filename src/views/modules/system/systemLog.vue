<template>
    <div>
        ...
        <!--数据表格  -->
        <Table :data="systemLogs" :columns="systemLogTableColumns" height="500" stripe></Table>
        <!--分页  -->
        ...
        <!--明细信息  -->
        <div>
            <Modal :mask-closable="false" :closable="false" v-model="modalShow" width="800" title="系统日志信息" ok-text="保存"
                ...
                <Form label-position="left" :label-width="80" ref="modalForm" :model="modalForm" :rules="modalRule">
                        <Row>
                            <Col span="11">
                            <Form-item label="日志主键" prop="id">
                                <Input v-model="modalForm.id" type="text"
                                       placeholder="请输入日志主键"></Input>
                            </Form-item>
                            </Col>
                        ...
                        <Row>
                            ...
                            <Form-item label="最后修改时间" prop="gmtModified">
                                ...
                                <Form-item label="日志状态"
                                           prop="status">
                                    <Input v-model="modalForm.status" type="text"
                                           placeholder="请输入日志状态"></Input>
                                </Form-item>
                                </Col>
                        </Row>
                        <Row>
                            <Col span="11">
                            <Form-item label="用户主键" prop="userId">
                                <Input v-model="modalForm.userId" type="text"
                                       placeholder="请输入用户主键"></Input>
                            </Form-item>
                            </Col>
                                <Col span="11" offset="2">
                                <Form-item label="用户名"
                                           prop="userName">
                                    <Input v-model="modalForm.userName" type="text"
                        ...
                        <Row>
                            <Col span="11">
                            <Form-item label="用户操作" prop="opration">
                                <Input v-model="modalForm.opration" type="text"
                                       placeholder="请输入用户操作"></Input>
                            </Form-item>
                            </Col>
                                <Col span="11" offset="2">
                                <Form-item label="请求方法"
                                           prop="method">
                                    <Input v-model="modalForm.method" type="text"
                                           placeholder="请输入请求方法"></Input>
                                </Form-item>
                                </Col>
                        </Row>
                        <Row>
                            <Col span="11">
                            <Form-item label="请求参数" prop="params">
                                <Input v-model="modalForm.params" type="text"
                                       placeholder="请输入请求参数"></Input>
                            </Form-item>
                            </Col>
                                <Col span="11" offset="2">
                                <Form-item label="IP地址"
                                           prop="ip">
                                    <Input v-model="modalForm.ip" type="text"
    ...
    export default {
        ...
        ,
            ...
            return {
                ...
                pageSize: 10,
                //table表格
                systemLogTableColumns: tableColumns,
                //父子通信属性
                modalShow: false,
                modalForm: {},
                modalRule: {},
        ...
        //钩子方法，页面渲染结束后加载
        created() {
            this.list_systemLog(this.current, this.pageSize);
        },
        methods: {
            //远程请求数据
            list_systemLog(current, pageSize) {
                //参数
                let params = {
                    'page': current,
                    'size': pageSize
                ...
                ;
                promise.then((result) => {
                    this.systemLogs = result.data.list;
            ...
            modalConfirmEvent() {
                ...
                if (self.modalForm.id == undefined || self.modalForm.id == null || self.modalForm.id == "") {
                    ...
                    promise.then((result) => {
                        //局部更新数据
                        Vue.set(self.systemLogs, self.modalIndex, result.data.data);
                    self.$Message.success("保存成功");
                })
                }
            },
            pageRefreshEvent(current, pageSize) {
                this.list_systemLog(current, pageSize);
            }
