<template>
    <div>
        ...
        <!--明细信息  -->
        <div>
            <Modal :mask-closable="false" :closable="false" v-model="modalShow" width="800" title="用户-角色信息" ok-text="保存"
                ...
                <Form label-position="left" :label-width="80" ref="modalForm" :model="modalForm" :rules="modalRule">
                        ...
                        <Row>
                            ...
                            <Form-item label="最后修改时间" prop="gmtModified">
                                ...
                                <Col span="11" offset="2">
                                <Form-item label="用户-角色状态"
                                           prop="status">
                                    <Input v-model="modalForm.status" type="text"
                                           placeholder="请输入用户-角色状态"></Input>
                                </Form-item>
                                </Col>
                        </Row>
                        <Row>
                            ...
                            <Form-item label="用户主键" prop="userId">
                                ...
                                <Col span="11" offset="2">
                                <Form-item label="角色主键"
                                           prop="roleId">
                                    <Input v-model="modalForm.roleId" type="text"
                                           placeholder="请输入角色主键"></Input>
                                </Form-item>
                                </Col>
                        </Row>
                </Form>
