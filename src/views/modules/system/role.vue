<template>
    <div>
        ...
        <!--数据表格  -->
        <Table :data="roles" :columns="roleTableColumns" height="500" stripe></Table>
        <!--分页  -->
        ...
        <!--明细信息  -->
        <div>
            <Modal :mask-closable="false" :closable="false" v-model="modalShow" width="800" title="角色信息" ok-text="保存"
                ...
                <Form label-position="left" :label-width="80" ref="modalForm" :model="modalForm" :rules="modalRule">
                        ...
                        <Row>
                            ...
                            <Form-item label="角色名称" prop="roleName">
                                <Input v-model="modalForm.roleName" type="text"
                                ...
                                <Form-item label="角色编码"
                                           prop="roleCode">
                                    <Input v-model="modalForm.roleCode" type="text"
                                           placeholder="请输入角色编码"></Input>
                                </Form-item>
                                </Col>
                        </Row>
                        <Row>
                            ...
                            <Form-item label="备注" prop="remark">
                                <Input v-model="modalForm.remark" type="text"
        ...
        methods: {
            ...
            modalConfirmEvent() {
                ...
                if (self.modalForm.id == undefined || self.modalForm.id == null || self.modalForm.id == "") {
                    ...
                    promise.then((result) => {
                        //局部更新数据
                        Vue.set(self.roles, self.modalIndex, result.data.data);
                    self.$Message.success("保存成功");
                })
                }
            },
            pageRefreshEvent(current, pageSize) {
                this.list_role(current, pageSize);
            }
